...
Vandaag bestaat de code/design review uit twee onderdelen. Je start met een review van de sitemap samen met je groepsgenoten. Daarna ga je in een nieuwe groep aan de slag met een code review, samen met peers die ongeveer op hetzelfde punt in het project zitten als jij.
...
Presenteer jouw gemaakte sitemap aan de groep. Leg uit hoe je tot deze indeling bent gekomen en waarom je voor deze naamgeving van de routes hebt gekozen. Benoem ook welke data je op welke pagina wilt tonen en welke endpoints daarbij horen.

Laat ieder teamlid aan de beurt komen. Wanneer je zelf niet presenteert, maak je aantekeningen van punten die je opvallen bij de sitemap van iemand anders.
