...
Bekijk ter voorbereiding ook wat er al in Directus klaarstaat voor jouw opdracht, en welke content er al is, zoals teksten, plaatjes, illustraties en/of documenten. Zorg dat je dit ook bespreekt met je opdrachtgever, in het data-driven web is het _content first_!

Zorg ervoor dat je met de opdrachtgever het gemaakte werk uit semester 1 bespreekt. Wat was goed? Waar wil de opdrachtgever mee verder? Je kan het gemaakte werk vinden in de project beschrijvingen bij FDND Agency.
